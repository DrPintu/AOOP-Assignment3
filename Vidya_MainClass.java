...
public class Vidya_MainClass {
    public static void main(String[] args) {
        ...
        panel.add(Label2Area);

        button.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // called when processButton is clicked
                String textgiven = Label1Area.getText();

                // Remove punctuation from the input text
                textgiven = textgiven.replaceAll("[\\p{Punct}&&[^']]", "");

                String[] words = textgiven.split("\\s+");
                ...
                Label2Area.setText(output.toString());
            }
